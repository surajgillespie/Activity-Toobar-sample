define(function () {
    ...
    //for creating the activity palette
    var activityButton = document.getElementById("activity-button");

    
    var neighbPalette = new palette.Palette(activityButton);
    var sampleText;
    sampleText = document.createElement('input');
    sampleText.type="text";
    sampleText.id="aname";
    sampleText.className="expand";
    var neighbContainer = neighbPalette.getContainer();
    ...
    neighbContainer.appendChild(sampleText);
    neighbContainer.appendChild(descriplabel);
    neighbContainer.appendChild(descripbox);
